...
// DbConnectionStatus is the resolver for the dbConnectionStatus field.
func (r *queryResolver) DbConnectionStatus(ctx context.Context) (*model.DBConnectionStatus, error) {
	panic(fmt.Errorf("not implemented: DbConnectionStatus - dbConnectionStatus"))
}

// CronStatus is the resolver for the cronStatus field.
func (r *queryResolver) CronStatus(ctx context.Context) (*model.CronStatus, error) {
	panic(fmt.Errorf("not implemented: CronStatus - cronStatus"))
}
